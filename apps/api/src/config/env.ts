...
const apiEnvSchema = z.object({
  ...
  PUBLIC_READ_RATE_LIMIT_WINDOW_MINUTES: z.coerce.number().int().positive().max(24 * 60).default(1),
  PUBLIC_READ_RATE_LIMIT_MAX_REQUESTS: z.coerce.number().int().positive().max(1000).default(120),
  CHECKER_CHECK_RATE_LIMIT_WINDOW_MINUTES: z.coerce.number().int().positive().max(24 * 60).default(5),
  CHECKER_CHECK_RATE_LIMIT_MAX_REQUESTS: z.coerce.number().int().positive().max(1000).default(30),
