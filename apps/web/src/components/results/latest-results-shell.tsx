...
interface LatestResultsShellProps {
  children: ReactNode;
  locale: SupportedLocale;
  messages: ResultsMessages;
}

export function LatestResultsShell({ children, locale, messages }: LatestResultsShellProps) {
  return (
    <div className="ui-page">
      <PublicHeader currentPath="latest" locale={locale} messages={messages} />
